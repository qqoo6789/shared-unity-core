...
namespace SharedCore.Editor
{
    public static class Constant
    {
        ...
        // 项目Assets资源路径 meland-unity/Assets
        public static readonly string AssetsPath = Path.Combine(ProjectPath, "Assets");
        // 项目临时文件夹 meland-unity/Temp
        public static readonly string TempPath = Path.Combine(ProjectPath, "Temp");
        // 编辑器插件 meland-unity/Assets/Plugins/SharedCore/Src/Editor 
        public static readonly string EditorPath = Path.Combine(AssetsPath, "Plugins/SharedCore/Src/Editor");
        // 通用的用于执行命令的sh文件 meland-unity/Assets/Plugins/SharedCore/Src/Editor/Common/CommonBash.sh
