 ...
 * @FilePath: /meland-unity/Assets/Plugins/SharedCore/Src/Runtime/Module/Battle/Skill/SkillShape/SkillShapeFactory.cs
 * 
 */
...
{
    public delegate SkillShapeBase CreateSkillShape(int[] parameters, GameObject entity, Vector3 dir);
    ...
    /// </summary>
    /// <returns></returns>
    public static SkillShapeBase CreateOneSkillShape(int[] parameters, GameObject entity, Vector3 dir)
    {
    ...
    private static SkillShapeBase CreateSkillShapeBox(int[] parameters, GameObject entity, Vector3 dir)
    {
    ...
    private static SkillShapeBase CreateSkillShapeSphere(int[] parameters, GameObject entity, Vector3 dir)
    {
    ...
    private static SkillShapeBase CreateSkillShapeCapsule(int[] parameters, GameObject entity, Vector3 dir)
    {
