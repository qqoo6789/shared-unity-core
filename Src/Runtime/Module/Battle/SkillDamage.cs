...
public class SkillDamage
{
    ...
    /// <returns></returns>
    public static (float damage, bool crit) CalculateHomeDamage(HomeDefine.eAction action, EntityAttributeData fromAttribute, EntityAttributeData toAttribute, float skillDamageRate, InputRandomData seedData)
    {
        ...
        float baseDamage = fromAttribute.GetRealValue(attributeClassify.Att) - toDef;
        baseDamage = Math.Max(0, baseDamage);
