...
* @Description: 碰撞触发效果
 * @FilePath: /meland-scene-server/Assets/Plugins/SharedCore/Src/Runtime/Module/Entity/Battle/SkillEffect/SECollisionTriggerCore.cs
* 
*/
...
public class SECollisionTriggerCore : SkillEffectBase
{
    ...
    public override void Start()
    {
        ...
        if (entityCollisionCore.EntityTriggerSet.Count > 0)
        {
            ...
            {
                EntityBase entity = GFEntryCore.GetModule<IEntityMgr>().GetEntity<EntityBase>(Id);
                if (entity != null)
                {
